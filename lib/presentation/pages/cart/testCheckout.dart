...
class _CheckoutPageState extends State<CheckoutPageTest> {
  ...
  String _orderStatusRequest() {
    ...
    _timer = Timer.periodic(Duration(seconds: 2), (timer) async {
      ...
      if (_elapsedTime >= 120 || status == 'PAID') {
        _timer.cancel();
        _cancelTimer.cancel();
  ...
  Future<void> _orderRequest() async {
    await apiServices.createOrder(
        ...
        useVpoint: 0);
    String? _getOrderID() {
      return getOrderID = apiServices.getOrderID();
    }
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  width: 240,
                  child: Image.network(
                    'https://qr.sepay.vn/img?acc=0000321753575&bank=MBBank&amount=${totalPrice}&des=ORD${getOrderID}&template=TEMPLATE&download=DOWNLOAD',
                  ),
                ),
                SizedBox(
                  height: 8,
